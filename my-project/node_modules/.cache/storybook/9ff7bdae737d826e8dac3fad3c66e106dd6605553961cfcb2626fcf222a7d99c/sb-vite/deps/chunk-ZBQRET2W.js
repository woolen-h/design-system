import {
  WithToolTipState
} from "./chunk-NFHKTYED.js";
import {
  $5e63c961fc1ce211$export$8c6ed5c666ac1360,
  ScrollArea,
  SyntaxHighlighter2
} from "./chunk-U5DQC6CU.js";
import {
  _extends,
...
var Link = ({ href: input, children, ...props }) => {
  ...
  return import_react.default.createElement("a", { href, target: isAnchorUrl ? "_self" : "_top", ...props }, children);
};
...
var LazySyntaxHighlighter = (0, import_react.lazy)(async () => {
  let { SyntaxHighlighter: SyntaxHighlighter3 } = await import("./syntaxhighlighter-P2EQDVYX-SIWWCJQK.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react.lazy)(async () => {
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([import("./syntaxhighlighter-P2EQDVYX-SIWWCJQK.js"), import("./formatter-U44HIZBV-SJL3R7GB.js")]);
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
...
var LazyWithTooltip = (0, import_react.lazy)(() => import("./WithTooltip-4IJ4T2ZO-Z3EG52MD.js").then((mod) => ({ default: mod.WithTooltip })));
...
var LazyWithTooltipPure = (0, import_react.lazy)(() => import("./WithTooltip-4IJ4T2ZO-Z3EG52MD.js").then((mod) => ({ default: mod.WithTooltipPure })));
...
var Icons = ({ icon, useSymbol, ...props }) => {
  (0, import_client_logger.deprecate)(`Use of the deprecated Icons ${`(${icon})` || ""} component detected. Please use the @storybook/icons component directly. For more informations, see the migration notes at https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#icons-is-deprecated`);
  ...
  let Icon = dist_exports[findIcon];
...
var Loader = ({ progress, error, size, ...props }) => {
  if (error)
    return import_react.default.createElement(ProgressWrapper, { "aria-label": error.toString(), "aria-live": "polite", role: "status", ...props }, import_react.default.createElement(ErrorIcon, { icon: "lightningoff" }), import_react.default.createElement(ProgressMessage, null, error.message));
  if (progress) {
...
//# sourceMappingURL=chunk-ZBQRET2W.js.map
