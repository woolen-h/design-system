...
import { withReset, SyntaxHighlighter, FlexBar, codeCommon, Icons, IconButton, Form, components, Zoom, ActionBar, Button, Link, ResetWrapper, Code, nameSpaceClassNames, H3, H2, Loader, TabsState, ErrorFormatter, getStoryHref, WithTooltipPure } from '@storybook/components';
import { transparentize, darken, opacify, lighten, rgba } from 'polished';
import { global } from '@storybook/global';
import { ZoomIcon, ZoomOutIcon, ZoomResetIcon, EyeCloseIcon, EyeIcon, DocumentIcon, UndoIcon, VideoIcon, SupportIcon, LinkIcon } from '@storybook/icons';
